...
export const catalogFixtures: readonly CatalogFixture[] = [
  {
    id: 'prod-serum',
    name: 'Serum Dưỡng Ẩm',
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'serum',
    imagePath: '/products/prod-serum.svg',
    imageAlt: 'Minh họa Serum Dưỡng Ẩm',
    displayOrder: 1,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'sunscreen',
    imagePath: '/products/prod-spf50.svg',
    imageAlt: 'Minh họa Kem Chống Nắng SPF50+',
    displayOrder: 2,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'cleansing',
    imagePath: '/products/prod-facewash.svg',
    imageAlt: 'Minh họa Sữa Rửa Mặt CeraVe',
    displayOrder: 3,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'serum',
    imagePath: '/products/prod-vitc.svg',
    imageAlt: 'Minh họa Tinh Chất Vitamin C',
    displayOrder: 4,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'toner',
    imagePath: '/products/prod-toner.svg',
    imageAlt: 'Minh họa Toner Cấp Ẩm',
    displayOrder: 5,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'cleansing',
    imagePath: '/products/prod-micellar.svg',
    imageAlt: 'Minh họa Nước Tẩy Trang Dịu Nhẹ',
    displayOrder: 6,
    variants: [
      {
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'cleansing',
    imagePath: '/products/prod-cleansing-oil.svg',
    imageAlt: 'Minh họa Dầu Tẩy Trang',
    displayOrder: 7,
    variants: [
  ...
  {
    id: 'prod-ceramide',
    name: 'Kem Dưỡng Ceramide',
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'moisturizer',
    imagePath: '/products/prod-ceramide.svg',
    imageAlt: 'Minh họa Kem Dưỡng Ceramide',
    displayOrder: 8,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'serum',
    imagePath: '/products/prod-niacinamide.svg',
    imageAlt: 'Minh họa Serum Niacinamide',
    displayOrder: 9,
    variants: [
      {
  ...
  {
    id: 'prod-retinol',
    name: 'Serum Retinol Dịu Nhẹ',
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'serum',
    imagePath: '/products/prod-retinol.svg',
    imageAlt: 'Minh họa Serum Retinol Dịu Nhẹ',
    displayOrder: 10,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'lips',
    imagePath: '/products/prod-lip-balm.svg',
    imageAlt: 'Minh họa Son Dưỡng Môi',
    displayOrder: 11,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'body',
    imagePath: '/products/prod-body-lotion.svg',
    imageAlt: 'Minh họa Sữa Dưỡng Thể',
    displayOrder: 12,
    variants: [
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'body',
    imagePath: '/products/prod-hand-cream.svg',
    imageAlt: 'Minh họa Kem Dưỡng Tay',
    displayOrder: 13,
    variants: [{ id: 'SKU-HAND-50G', sku: 'SKU-HAND-50G', displayName: '50 g', listPrice: 65000n }],
  },
  {
    id: 'prod-mask',
    name: 'Mặt Nạ Cấp Ẩm',
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'mask',
    imagePath: '/products/prod-mask.svg',
    imageAlt: 'Minh họa Mặt Nạ Cấp Ẩm',
    displayOrder: 14,
    variants: [
  ...
  {
    id: 'prod-shampoo',
    name: 'Dầu Gội Dịu Nhẹ',
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'hair',
    imagePath: '/products/prod-shampoo.svg',
    imageAlt: 'Minh họa Dầu Gội Dịu Nhẹ',
    displayOrder: 15,
    variants: [
      {
  ...
  },
  {
    ...
    description: 'Sản phẩm chăm sóc cá nhân dịu nhẹ dùng hằng ngày.',
    category: 'hair',
    imagePath: '/products/prod-conditioner.svg',
    imageAlt: 'Minh họa Dầu Xả Dưỡng Ẩm',
    displayOrder: 16,
    variants: [
      {
